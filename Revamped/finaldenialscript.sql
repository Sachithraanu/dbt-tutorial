...
left join --collection status
 ...
 on ufslo1.LicenseKey = ufv1.LicenseKey and ufslo1.Value = ufv1.TextValue
...
on colst.LicenseKey = ufv.LicenseKey and colst.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,colst.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on ufslo2.LicenseKey = ufv2.LicenseKey and ufslo2.Value = ufv2.TextValue
...
on moi.LicenseKey = ufv.LicenseKey and moi.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,moi.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on ufslo3.LicenseKey = ufv3.LicenseKey and ufslo3.Value = ufv3.TextValue
...
on fut.LicenseKey = ufv.LicenseKey and fut.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,fut.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on icn.LicenseKey = ufv.LicenseKey and icn.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,icn.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on ufslo4.LicenseKey = ufv4.LicenseKey and ufslo4.Value = ufv4.TextValue
...
on dr.LicenseKey = ufv.LicenseKey and dr.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,dr.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on ufslo5.LicenseKey = ufv5.LicenseKey and ufslo5.Value = ufv5.TextValue
...
on ca1.LicenseKey = ufv.LicenseKey and ca1.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,ca1.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on note.LicenseKey = ufv.LicenseKey and  note.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,note.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
...
on wd.LicenseKey = ufv.LicenseKey and wd.UserFileInstanceFID = ufv.UserFileInstanceFID and CONVERT(varchar,wd.CreatedAt,21) = CONVERT(varchar,ufv.CreatedAt,21)
